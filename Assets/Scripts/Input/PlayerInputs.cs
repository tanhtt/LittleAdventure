    ...
    public struct PlayerActions
    {
        ...
        public void SetCallbacks(IPlayerActions instance)
        {
            if (m_Wrapper.m_PlayerActionsCallbackInterface != null)
            {
                ...
                @EquipSlot3.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot3;
                @EquipSlot3.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot3;
                @EquipSlot3.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot3;
                @EquipSlot4.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot4;
                @EquipSlot4.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot4;
                @EquipSlot4.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot4;
                @EquipSlot5.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot5;
                @EquipSlot5.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot5;
                @EquipSlot5.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipSlot5;
                ...
                @ToggleWeaponMode.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnToggleWeaponMode;
                @ToggleWeaponMode.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnToggleWeaponMode;
                @ToggleWeaponMode.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnToggleWeaponMode;
            }
